                  ...
                  {logs.map((log, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td 
                          className="py-3 px-4 font-mono text-xs text-gray-600 max-w-xs truncate hidden md:table-cell" 
                          data-tooltip={log.clientIp || undefined}
                          title={log.clientIp || undefined}
                        >
